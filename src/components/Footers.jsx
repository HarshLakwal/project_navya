                    ...
                    <motion.div variants={itemVariants}>
                        ...
                        <address className="not-italic text-gray-400">
                            <motion.p
                                ...
                                viewport={{ once: true }}
                            >
                                Office No. 404, The Heritage, 582
                            </motion.p>
                            <motion.p
                                initial={{ opacity: 0 }}
                                whileInView={{ opacity: 1 }}
                                ...
                                viewport={{ once: true }}
                            >
                                Mahatma Gandhi Rd, New Palasia, Indore,
                            ...
                            <motion.p
                                ...
                                viewport={{ once: true }}
                            >
                                Phone: +917987709774 +919977732199
                            </motion.p>
                            <motion.p
                                initial={{ opacity: 0 }}
                                whileInView={{ opacity: 1 }}
                                ...
                                viewport={{ once: true }}
                            >
                                Email: navyaadvertisingindore@gmail.com
                            </motion.p>
                        </address>
                    </motion.div>

                    <motion.div
                        className=" flex items-center flex-col mt-0 pt-1 border-t border-gray-100"
                        variants={itemVariants}
                    >
                        <h4 className="font-medium text-gray-400 mb-4 mt-4">Follow Us</h4>
