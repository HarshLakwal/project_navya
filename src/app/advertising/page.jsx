...
// // Icons for services (using Heroicons)
// const servicesData = [
//   {
//     icon: (
...
//           <div className="absolute bottom-10 left-1/2 w-72 h-72 bg-accent rounded-full mix-blend-multiply filter blur-xl animate-blob animation-delay-4000"></div>
//         </div>
...
//                 <button className="bg-gradient-to-r cursor-pointer from-primary to-[#822431] text-white font-medium py-3 px-8 rounded-lg shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300">
//                   Explore Our Services
//                 </button>
//                 <Link href={"/contact-us"}>
//                 <button className="bg-white cursor-pointer text-gray-800 font-medium py-3 px-8 rounded-lg shadow-md border border-gray-200 hover:shadow-lg transform hover:-translate-y-1 transition-all duration-300">
//                   Contact Us
//                 </button>
//                 </Link>
...
//           <div className="bg-gradient-to-r from-primary to-[#822431] rounded-3xl p-10 mb-20 text-white relative overflow-hidden">
...
//                     </ul>
//                   )}
//                   <button className="mt-8 bg-gradient-to-r from-primary to-[#822431] text-white font-medium py-3 px-6 rounded-lg shadow-md hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
...
//                       className="group flex-shrink-0 w-56 h-32 px-4 bg-white/5 rounded-2xl flex items-center justify-center backdrop-filter backdrop-blur-sm border border-white/10 hover:bg-white/10 transition-all duration-500 hover:scale-105 hover:shadow-xl"
//                     >
//                       <span
//                         className="text-lg font-medium text-white/90 group-hover:text-white truncate w-full text-center"
//                         title={brand} // shows full name on hover tooltip
//                       >
//                         {brand}
//                       </span>
//                     </div>
...
//             <div className="text-center p-6 bg-white/5 rounded-2xl backdrop-filter backdrop-blur-sm border border-white/10">
...
//           {/* Testimonial Preview */}
//           {/* <div className="bg-white/5 rounded-3xl p-8 md:p-12 backdrop-filter backdrop-blur-sm border border-white/10">
//             <div className="flex items-start">
//               <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-white/30 mr-4 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
//                 <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
//               </svg>
//               <div>
//                 <p className="text-xl italic mb-6">
//                   "NAVYA's innovative advertising solutions helped us increase brand visibility by 40% in just three months. Their end-to-end approach saved us time and resources while delivering exceptional results."
//                 </p>
//                 <div className="flex items-center">
//                   <div className="w-12 h-12 bg-white/10 rounded-full mr-4 flex items-center justify-center">
//                     <span className="font-bold">RM</span>
//                   </div>
//                   <div>
//                     <div className="font-semibold">Rahul Mehta</div>
//                     <div className="text-white/70">Marketing Director, Premium Brand</div>
//                   </div>
//                 </div>
//               </div>
//             </div>
...
//             <Link href={"/contact-us"}>
//             <button className="bg-white text-primary font-semibold py-3 px-8 rounded-lg shadow-lg hover:bg-gray-100 transform hover:-translate-y-1 transition-all duration-300">
//               Become Our Client
//             </button>
//             </Link>
