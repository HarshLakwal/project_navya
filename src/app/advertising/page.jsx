    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-200 to-gray-100">
      ...
      <section id="clients" className="py-20 bg-gradient-to-r from-primary to-[#822431] text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          {/* Client Logos Slider - UPDATED WITH BETTER SPACING */}
          <motion.div 
            initial={{ opacity: 0 }}
          ...
          >
            <div className="flex animate-scroll">
              {[...Array(2)].map((_, loopIndex) => (
                <div key={loopIndex} className="flex gap-10 px-4">
                  {[
                    ...
                    <motion.div
                      ...
                      className="group flex-shrink-0 w-60 h-36 px-6 py-4 bg-white/5 rounded-2xl flex items-center justify-center backdrop-filter backdrop-blur-sm border border-white/10 transition-all duration-300 mx-2"
                    >
                      <span
                        className="text-lg font-medium text-white/90 group-hover:text-white text-center leading-tight px-2"
                        title={brand}
                      >
                        {brand}
                      </span>
            ...
            <div className="absolute top-0 left-0 h-full w-32 bg-gradient-to-r from-primary to-transparent z-10"></div>
            <div className="absolute top-0 right-0 h-full w-32 bg-gradient-to-l from-[#822431] to-transparent z-10"></div>
          </motion.div>
