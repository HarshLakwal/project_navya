...
//                 whileTap={{ scale: 0.95 }}
//                 className="bg-primary hover:bg-[#822431] text-white px-8 py-3 rounded-lg font-medium shadow-lg text-lg"
//               >
//                 Plan Your Event
//               </motion.button>
//             </Link>
...
//                 whileHover={{ scale: 1.05 }}
//                 whileTap={{ scale: 0.95 }}
//                 className="bg-white/20 backdrop-blur-md border-2 border-white text-white hover:bg-white/30 px-8 py-3 rounded-lg font-medium text-lg"
//               >
//                 View Our Work
//               </motion.button>
//             </Link>
...
//           <h2 className="text-4xl font-extrabold text-center text-primary mb-4">What We Do</h2>
...
//                     <span className="text-4xl mb-2 inline-block">{service.icon}</span>
...
//         <div className="container mx-auto px-4">
//           <h2 className="text-4xl font-extrabold text-center text-primary mb-12">Our Work</h2>
...
//                     <button className="bg-primary hover:bg-[#822431] text-white px-4 py-2 rounded-lg text-sm font-medium">
//                       View Project
//                     </button>
//                   </div>
//                 </div>
...
//       <section className="py-16 bg-white">
//         <div className="container mx-auto px-4">
//           <h2 className="text-4xl font-extrabold text-center text-primary mb-4">Advertising Solutions</h2>
//           <p className="text-center text-gray-600 max-w-2xl mx-auto mb-12">
...
//               <motion.div
//                 key={index}
//                 className="relative rounded-xl overflow-hidden shadow-lg group cursor-pointer h-96"
...
//                   <div className="h-0 overflow-hidden group-hover:h-16 transition-all duration-500">
...
//       {/* Testimonial Section */}
//       <section className="py-16 bg-primary text-white mb-4">
...
//                 <p className="text-sm text-white/70">{testimonial.type}</p>
//               </motion.div>
//             ))}
//           </div>
//         </div>
...
//       {/* CTA Section */}
//       <section className="py-20 bg-cover bg-center relative mb-4">
//         <div className="absolute inset-0 bg-primary/90"></div>
//         <div className="container mx-auto px-4 text-center relative z-10 text-white">
//           <h2 className="text-3xl font-bold mb-4">Ready to Create Something Amazing?</h2>
//           <p className="text-xl mb-8 max-w-2xl mx-auto">Let's discuss your vision and bring it to life</p>
//           <div className="flex flex-col sm:flex-row justify-center gap-4">
//             <motion.button
//               whileHover={{ scale: 1.05 }}
//               whileTap={{ scale: 0.95 }}
//               className="bg-white text-primary hover:bg-gray-100 px-8 py-3 rounded-lg font-medium shadow-lg text-lg"
//             >
//               Start Planning
//             </motion.button>
//             <motion.button
//               whileHover={{ scale: 1.05 }}
//               whileTap={{ scale: 0.95 }}
//               className="bg-transparent border-2 border-white text-white hover:bg-white/10 px-8 py-3 rounded-lg font-medium text-lg"
//             >
//               Request a Quote
//             </motion.button>
//           </div>
        ...
        <div className="container mx-auto px-4 text-center relative z-10 text-white">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-3 md:gap-4">
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="bg-white text-primary hover:bg-gray-100 px-6 py-2 md:px-8 md:py-3 rounded-lg font-medium shadow-lg text-base md:text-lg"
            >
              Start Planning
            </motion.button>
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="bg-transparent border-2 border-white text-white hover:bg-white/10 px-6 py-2 md:px-8 md:py-3 rounded-lg font-medium text-base md:text-lg"
            >
              Request a Quote
            </motion.button>
          </div>
